...
![Учетная запись GitHub](image/6.jpg ){#fig:006 width=100%}
...
![Создание репозитория](image/10.jpg ){#fig:010 width=100%}
...
![Отправка на сервер](image/12.jpg ){#fig:012 width=100%}
