...
Для этого ввел `gedit prog1.sh`, чтобы вызвать gedit редактор и создать файл для скрипта. После ввожу скрипт необходимый заданию (рис. [-@fig:001]). 

![Скрипт 1](image/1.jpg ){#fig:001 width=100%}

Делаю файл исполняемым с помощью `chmod +x prog1.sh` и проверяю, сработал ли скрипт. (рис. [-@fig:002]).

![Результат работы скрипта №1](image/2.jpg ){#fig:002 width=100%}

2. Нужно написать пример командного файла, обрабатывающего любое произвольное число аргументов командной строки. (рис. [-@fig:003]):

![Скрипт 2](image/3.jpg ){#fig:003 width=100%}

Сделал файл исполняемым и вывел результат. (рис. [-@fig:004]).
    
![Результат работы скрипта №2](image/4.jpg ){#fig:004 width=100%}
...
![Скрипт 3](image/5.jpg ){#fig:005 width=100%}

Сделал файл исполняемым и вывел результат (рис. [-@fig:006]).
    
![Результат работы скрипта №3](image/6.jpg ){#fig:006 width=100%}
...
![Скрипт 4](image/7.jpg){#fig:007 width=100%}

Сделал файл исполняемым и вывел результат (рис. [-@fig:008]).
    
![Результат работы скрипта №4](image/8.jpg ){#fig:008 width=100%}
...
Изучил основы программирования в оболочке ОС UNIX/Linux, а также научился писать небольшие командные файлы.
